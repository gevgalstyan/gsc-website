import { Award, CalendarCheck, CircleUserRound, Heart, LockKeyhole, Sparkles } from "lucide-react";
...
export default async function MembershipPage() {
  ...
  return <PublicPageShell eyebrow="Membership" title={content["membership.hero.title"] || "A member space that keeps your progress close"} intro={content["membership.intro"] || "The current GSC application connects a member profile with question progress, favorites, attendance records, bookings, and loyalty rewards."} breadcrumbLabel="Membership" breadcrumbPath="/membership">
